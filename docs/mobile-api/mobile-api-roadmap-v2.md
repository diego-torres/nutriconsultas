...
>
> - **Backend schema (2026-06-14):** Phase 0 **done** (#107 PR #117, #109 PR #142, #110). **All endpoints #91–#99 on `main`** (PR #153: progress measurements). **#96/#97** messaging (`PatientMessage` entity, POST returns **201**, Resilience4j **10/min** per `patientAuthSub` — #113, PR #151). **#111** localized `ApiResponse` errors (403/404/400/429). **NEXT:** #112 OpenAPI. #116 optional `senderDisplayName`; #106 dashboard IMC gauge **done**.
