...
**Epics #232–#242** (2026-06-19): diet catalog (#232–#235) **complete**, branding (#236–#237), diet/platillo UX (#238–#240), patient UX (#241–#242). ~~#236~~ **done** (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274)). Platillo ownership ~~#257–#259~~ done (#259 PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270)). **Epic #271–#272** (2026-06-20): platform admin **create** system catalog platillos/diets (edit exists via #232/#257; create gap). **NEXT:** [#237 PDF logo sizing](https://github.com/diego-torres/nutriconsultas/issues/237). See [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md).
