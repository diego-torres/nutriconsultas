...
**Epic #180–#211** (2026-06-19): ~~#46~~ Liquibase done; ~~#180–#185~~, ~~#190~~, ~~#187~~, ~~#210~~, ~~#211~~, ~~#220~~, ~~#186~~ on `main`. Public funnel: ~~#243~~ reCAPTCHA **done**. ~~#207~~ **done** (PR [#308](https://github.com/diego-torres/nutriconsultas/pull/308)). ~~#208~~ **done** (PR [#309](https://github.com/diego-torres/nutriconsultas/pull/309)). ~~#209~~ **done** (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). ~~#220~~ **done** (PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313)). **NEXT:** #188 director invitations. See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Next:** [#134](https://github.com/diego-torres/nutriconsultas/issues/134) create patient invitation (~~#133~~ PR [#229](https://github.com/diego-torres/nutriconsultas/pull/229) on `main`). ~~#114~~, ~~#116~~, ~~#115~~, ~~#112~~ **done**. Subscription: [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md) — ~~#186~~ done; **NEXT** #188.
