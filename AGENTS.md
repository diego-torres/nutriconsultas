...
**Epic #180–#211** (2026-06-19): ~~#46~~ Liquibase done; ~~#180–#185~~, ~~#190~~, ~~#187~~, ~~#210~~, ~~#211~~, ~~#220~~, ~~#186~~, ~~#188~~, ~~#314~~, ~~#244~~ (`subscription/244-contact-form-prefill`). Public funnel: ~~#243~~ ~~#244~~ **done**. ~~#207~~ **done** (PR [#308](https://github.com/diego-torres/nutriconsultas/pull/308)). ~~#208~~ **done** (PR [#309](https://github.com/diego-torres/nutriconsultas/pull/309)). ~~#209~~ **done** (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). ~~#220~~ **done** (PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313)). **Registered subscription track complete.** See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Next:** Phase 2 invitation onboarding **complete** (~~#141~~). ~~#337~~ web landing **done** (PR TBD). ~~#140~~ done ([`docs/auth0/PATIENT-POST-LOGIN-GATE.md`](docs/auth0/PATIENT-POST-LOGIN-GATE.md)).
