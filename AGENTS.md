...
**Epic #180–#211** (2026-06-19): ~~#46~~ Liquibase done; ~~#180–#185~~, ~~#190~~, ~~#187~~, ~~#210~~, ~~#211~~, ~~#220~~, ~~#186~~, ~~#188~~ on `subscription/188-director-invitations`. Public funnel: ~~#243~~ reCAPTCHA **done**. ~~#207~~ **done** (PR [#308](https://github.com/diego-torres/nutriconsultas/pull/308)). ~~#208~~ **done** (PR [#309](https://github.com/diego-torres/nutriconsultas/pull/309)). ~~#209~~ **done** (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). ~~#220~~ **done** (PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313)). **NEXT:** #314 director patient transfers. See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Next:** [#134](https://github.com/diego-torres/nutriconsultas/issues/134) create patient invitation (~~#133~~ PR [#229](https://github.com/diego-torres/nutriconsultas/pull/229) on `main`). ~~#114~~, ~~#116~~, ~~#115~~, ~~#112~~ **done**. Subscription: [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md) — ~~#188~~ done; **NEXT** #314.
...
**Epics #232–#242** (2026-06-19): diet catalog (#232–#235) **complete**, branding (#236–#237) **complete**, diet/platillo UX (#238–#240) **complete**, patient UX (#241–#242) **complete**. ~~#236~~ **done** (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274)). ~~#237~~ **done** (PR [#278](https://github.com/diego-torres/nutriconsultas/pull/278)). Platillo ownership ~~#257–#259~~ done (#259 PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270)). **Epic #271–#272** (2026-06-20): platform admin **create** system catalog platillos/diets — ~~#271~~ **done** (PR [#288](https://github.com/diego-torres/nutriconsultas/pull/288)); ~~#272~~ **done** (PR [#289](https://github.com/diego-torres/nutriconsultas/pull/289)). ~~#238~~ **done** (PR [#279](https://github.com/diego-torres/nutriconsultas/pull/279)). ~~#239~~ **done** (`issue-239-ingredient-weight-recalc`, bd07fb4). ~~#240~~ **done** (PR [#283](https://github.com/diego-torres/nutriconsultas/pull/283)). **Epic #280–#281** (2026-06-20): diet full nutrients modal + in-row platillo ingredient edit on ingesta grid. ~~#280~~ **done** (PR [#284](https://github.com/diego-torres/nutriconsultas/pull/284)). ~~#281~~ **done** (`issue-281-ingesta-platillo-ingredient-edit`). **Epic #285** (2026-06-21): platillo form inline ingredient cantidad editing. ~~#285~~ **done** (`issue-285-platillo-inline-cantidad`, 340a318). ~~#241~~ **done** (PR [#291](https://github.com/diego-torres/nutriconsultas/pull/291)). ~~#242~~ **done** (branch `issue-242-anthropometric-field-edit`). See [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md).
