...
**Last updated:** 2026-06-27 — `POST /rest/mobile/invitations/reconcile` (post-login JWT email linkage; branch `feat/invitation-redeem-by-human-code`). ~~#336~~ **done**. ~~#141~~ **done**. **Phase 2 invitation onboarding complete.** ~~#337~~ web landing **done**. Mobile F9 (#62–#67) + reconcile in `PostAuthCoordinator`.
