...
**Last updated:** 2026-06-26 — ~~#336~~ **done** (human-code preview + `POST …/by-code/{code}/redeem`; Auth0 gate human-code preview). ~~#141~~ **done**. **Phase 2 invitation onboarding complete.** ~~#337~~ web landing **done**. Mobile F9 (#62–#66) shipped in `nutriconsultas-mobile`.
...
| 136 | `POST /rest/mobile/invitations/{token}/redeem` — bind Auth0 sub → patient | https://github.com/diego-torres/nutriconsultas/issues/136 | **done** | ~~132~~ ✓, ~~133~~ ✓, 107 | Merged PR [#325](https://github.com/diego-torres/nutriconsultas/pull/325); extended `POST …/by-code/{code}/redeem` for human codes (mobile #65) |
