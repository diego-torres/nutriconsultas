...
| **598** | Patient-accessible platillo image for diet plan (S3 → patient JWT) | https://github.com/diego-torres/nutriconsultas/issues/598 | **in-progress** | ~~94~~ ✓, ~~352~~ ✓, ~~355~~, ~~529~~ | Branch `mobile-api/598-patient-platillo-image`; `GET …/platillos/{id}/image`; DTO `imageUrl` rewritten to mobile/static path. Mobile follow-up [nutriconsultas-mobile#145](https://github.com/Escanor4323/nutriconsultas-mobile/issues/145) |
