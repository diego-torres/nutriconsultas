...
**Current next issue (AI assistant):** [#364 — Epic Backend OpenAI Integration](https://github.com/diego-torres/nutriconsultas/issues/364) (`NEXT`). ~~#363~~ **done** — [`docs/ai/TOOL-CONTRACT.md`](docs/ai/TOOL-CONTRACT.md). See [`ISSUE-AI-ASSISTANT.md`](ISSUE-AI-ASSISTANT.md).
