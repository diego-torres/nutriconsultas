...
**Current next issue (nutritionist web):** [#236 — Show uploaded logo on nutritionist profile page](https://github.com/diego-torres/nutriconsultas/issues/236). ~~#259~~ done (PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270), `Fixes #259`). ~~#258~~ done (PR [#269](https://github.com/diego-torres/nutriconsultas/pull/269)). ~~#257~~ done (PR [#268](https://github.com/diego-torres/nutriconsultas/pull/268)). See [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md).
