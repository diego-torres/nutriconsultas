...
**Current next issue (AI assistant):** [#366 — Add OpenAI Java Client](https://github.com/diego-torres/nutriconsultas/issues/366) (`NEXT`). ~~#365~~ **done** — `com.nutriconsultas.ai.AiProperties`. See [`ISSUE-AI-ASSISTANT.md`](ISSUE-AI-ASSISTANT.md).
