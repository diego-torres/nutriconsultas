...
| File | Purpose |
|------|---------|
| [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md) | `[Nutritionist Web]` issues (#221–#223 MPX; #232–#242 epics; #257–#259 platillo ownership; #271–#272 system catalog create; #280–#281 diet nutrients & ingesta platillo edit; ~~#250~~), states, dependencies |
...
**Current next issue (nutritionist web):** [#281 — in-row platillo ingredient edit on ingesta grid](https://github.com/diego-torres/nutriconsultas/issues/281). ~~#280~~ done (PR [#284](https://github.com/diego-torres/nutriconsultas/pull/284), `Fixes #280`). ~~#240~~ done (PR [#283](https://github.com/diego-torres/nutriconsultas/pull/283), `Fixes #240`). ~~#239~~ done (`issue-239-ingredient-weight-recalc`, bd07fb4). ~~#238~~ done (PR [#279](https://github.com/diego-torres/nutriconsultas/pull/279), `Fixes #238`). ~~#237~~ done (PR [#278](https://github.com/diego-torres/nutriconsultas/pull/278), `Fixes #237`). ~~#236~~ done (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274), `Fixes #236`). ~~#259~~ done (PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270), `Fixes #259`). ~~#258~~ done (PR [#269](https://github.com/diego-torres/nutriconsultas/pull/269)). ~~#257~~ done (PR [#268](https://github.com/diego-torres/nutriconsultas/pull/268)). See [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md).
...
**Nutritionist web (parallel):** [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md) — ~~#280~~ done (PR [#284](https://github.com/diego-torres/nutriconsultas/pull/284)); ~~#240~~ done (PR [#283](https://github.com/diego-torres/nutriconsultas/pull/283)); ~~#238~~ done (PR [#279](https://github.com/diego-torres/nutriconsultas/pull/279)); ~~#239~~ done (`issue-239-ingredient-weight-recalc`, bd07fb4); ~~#236~~ done (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274)); ~~#237~~ done (PR [#278](https://github.com/diego-torres/nutriconsultas/pull/278)); platillo ownership ~~#257–#259~~ done (#259 PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270)); system catalog create #271–#272 registered; diet nutrients & ingesta platillo edit #280–#281 registered; **NEXT:** #281 in-row platillo ingredient edit on ingesta grid.
