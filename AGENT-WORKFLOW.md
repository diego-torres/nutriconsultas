...
**Current next issue (subscription):** [#220 — Retention cleanup](https://github.com/diego-torres/nutriconsultas/issues/220) (or #186 clinic hierarchy). ~~#209~~ merged PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310). See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Subscription track (parallel):** see [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md). ~~#180–#185~~, ~~#187~~ (PR #218), ~~#190~~ (PR #216), ~~#210~~ (PR #224), ~~#211~~ (PR [#230](https://github.com/diego-torres/nutriconsultas/pull/230)) on `main`. ~~#207~~ ~~#208~~ ~~#209~~ done (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). **NEXT:** #220 retention, #186 clinic hierarchy.
