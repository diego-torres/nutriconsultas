...
**Current next issue (subscription):** [#209 — Invitation email](https://github.com/diego-torres/nutriconsultas/issues/209) **in-progress** (`subscription/209-invitation-email-ses`). ~~#208~~ merged PR [#309](https://github.com/diego-torres/nutriconsultas/pull/309). See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md) and [`docs/subscription/INVITATION-EMAIL.md`](docs/subscription/INVITATION-EMAIL.md).
...
**Subscription track (parallel):** see [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md). ~~#180–#185~~, ~~#187~~ (PR #218), ~~#190~~ (PR #216), ~~#210~~ (PR #224), ~~#211~~ (PR [#230](https://github.com/diego-torres/nutriconsultas/pull/230)) on `main`. ~~#207~~ done; ~~#208~~ done (PR [#309](https://github.com/diego-torres/nutriconsultas/pull/309)). **NEXT:** #209 invitation email, retention #220.
