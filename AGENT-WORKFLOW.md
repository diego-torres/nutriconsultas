...
**Current next issue (nutritionist web):** [#238 — diet detail macronutrients table](https://github.com/diego-torres/nutriconsultas/issues/238). ~~#237~~ done (PR [#278](https://github.com/diego-torres/nutriconsultas/pull/278), `Fixes #237`). ~~#236~~ done (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274), `Fixes #236`). ~~#259~~ done (PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270), `Fixes #259`). ~~#258~~ done (PR [#269](https://github.com/diego-torres/nutriconsultas/pull/269)). ~~#257~~ done (PR [#268](https://github.com/diego-torres/nutriconsultas/pull/268)). See [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md).
...
**Nutritionist web (parallel):** [`ISSUE-NUTRITIONIST-WEB.md`](ISSUE-NUTRITIONIST-WEB.md) — ~~#236~~ done (PR [#274](https://github.com/diego-torres/nutriconsultas/pull/274)); ~~#237~~ done (PR [#278](https://github.com/diego-torres/nutriconsultas/pull/278)); platillo ownership ~~#257–#259~~ done (#259 PR [#270](https://github.com/diego-torres/nutriconsultas/pull/270)); system catalog create #271–#272 registered; **NEXT:** #238 diet macro table.
