...
**Current next issue (subscription):** [#314 — Director patient transfers](https://github.com/diego-torres/nutriconsultas/issues/314). ~~#188~~ done. See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Subscription track (parallel):** see [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md). ~~#180–#185~~, ~~#187~~ (PR #218), ~~#190~~ (PR #216), ~~#210~~ (PR #224), ~~#211~~ (PR [#230](https://github.com/diego-torres/nutriconsultas/pull/230)), ~~#220~~ (PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313)), ~~#186~~, ~~#188~~ on `subscription/188-director-invitations`. ~~#207~~ ~~#208~~ ~~#209~~ done (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). **NEXT:** #314 director patient transfers.
