...
**Current next issue (subscription):** [#244 — Contact form pre-fill](https://github.com/diego-torres/nutriconsultas/issues/244). ~~#314~~ done (`subscription/314-patient-transfers`). See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
...
**Subscription track (parallel):** see [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md). ~~#180–#185~~, ~~#187~~ (PR #218), ~~#190~~ (PR #216), ~~#210~~ (PR #224), ~~#211~~ (PR [#230](https://github.com/diego-torres/nutriconsultas/pull/230)), ~~#220~~ (PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313)), ~~#186~~, ~~#188~~, ~~#314~~ (`subscription/314-patient-transfers`). ~~#207~~ ~~#208~~ ~~#209~~ done (PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310)). **NEXT:** #244 contact form pre-fill.
