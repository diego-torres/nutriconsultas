...
**Current next issue (AI assistant):** [#390 — Build Draft Preview UI](https://github.com/diego-torres/nutriconsultas/issues/390) (`NEXT`). ~~#389~~ **done** — chat window + REST. See [`ISSUE-AI-ASSISTANT.md`](ISSUE-AI-ASSISTANT.md).
