...
**Current next issue (subscription):** [#186 — Clinic hierarchy](https://github.com/diego-torres/nutriconsultas/issues/186). ~~#220~~ PR [#313](https://github.com/diego-torres/nutriconsultas/pull/313). See [`ISSUE-SUBSCRIPTION.md`](ISSUE-SUBSCRIPTION.md).
