...
**On `main` (2026-06-22):** Mobile **NEXT:** #134. Subscription **NEXT:** #208 (~~#207~~ Stripe provider done on `issue-207-stripe-payment-provider`). Nutritionist web: all registered epics **complete** (#221–#242, #271–#272). Public booking: epic ~~#245~~ **done** (v1); ~~#246~~–~~#302~~ shipped.
