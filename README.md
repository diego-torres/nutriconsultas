...
**On `main` (2026-06-15):** Phase 0 auth (#107, #109, #110); all patient endpoints #91–#99; localized API errors (#111); rate limit (#113); **OpenAPI #112** (PR #164); **PHI audit #115** (PR #168). **Next:** #116 `senderDisplayName`.
