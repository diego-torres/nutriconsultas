...
public class ClinicalExamServiceImpl implements ClinicalExamService {
	...
	@Override
	@Transactional(readOnly = true)
	public ClinicalExam findById(final Long id) {
	...
	@Override
	@Transactional
	public ClinicalExam save(final ClinicalExam exam) {
	...
	@Override
	@Transactional(readOnly = true)
	public List<ClinicalExam> findByPacienteId(final Long pacienteId) {
