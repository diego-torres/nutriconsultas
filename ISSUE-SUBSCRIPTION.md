...
**Last updated:** 2026-06-22 — ~~#186~~ **done** (branch `subscription/186-clinic-director-admin`).
...
| ~~209~~ | Invitation email — SES (Terraform) + localhost console sender | https://github.com/diego-torres/nutriconsultas/issues/209 | **done** | 184 | PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310); [`INVITATION-EMAIL.md`](docs/subscription/INVITATION-EMAIL.md) |
...
| 184 | Admin invitations + payment checkout | https://github.com/diego-torres/nutriconsultas/issues/184 | **done** | 180, 182, 183 | Merged [PR #206](https://github.com/diego-torres/nutriconsultas/pull/206); GitHub closed 2026-06-17. Live checkout → Stripe (#207/#208); email delivery → ~~#209~~ ✓ PR [#310](https://github.com/diego-torres/nutriconsultas/pull/310) |
...
| 188 | Director invitations for nutritionists (no payment) | https://github.com/diego-torres/nutriconsultas/issues/188 | **NEXT** | ~~186~~ ✓, 185 | Inherits clinic subscription |
| 314 | Director transfers patients between clinic nutritionists | https://github.com/diego-torres/nutriconsultas/issues/314 | open | ~~186~~ ✓, 188 | Reassign `Paciente.userId` within consultorio |
...
**Suggested order:** ~~#220~~ ✓. **NEXT:** #188 director invitations.
